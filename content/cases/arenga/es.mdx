...
bullets:
  - 8 productos entregados en 18 meses
  - Operamos sin inversión externa desde el día uno
  - Clientes recurrentes captados por referidos directos
  - Máximo 3 proyectos en paralelo como regla operativa
...
**Spark Club** — Plataforma de membresías para un social club tech en CABA. Fuimos desde research con socios hasta producción en once semanas. El flujo crítico (onboarding de nuevo socio + primer evento) se simplificó drásticamente. La tasa de completación del onboarding mejoró de forma significativa.
...
En 18 meses: 8 productos entregados, con clientes que volvieron a proyectos recurrentes y varios referidos directos entre el portfolio. Operamos sin inversión externa.
