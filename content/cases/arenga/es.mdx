...
outcome: 'Co-fundé un estudio digital. En 18 meses entregamos 8 productos, con una tasa de adopción a 30 días que usamos como métrica principal sobre la facturación.'
...
metrics:
  - { label: 'PRODUCTOS ENTREGADOS', value: 8 }
  - { label: 'CLIENTES RECURRENTES', value: 2 }
  - { label: 'REFERIDOS DIRECTOS', value: 3 }
  - { label: 'MESES SIN INVERSIÓN', value: 18 }
---
...
Nuestro criterio de aceptación de proyectos tiene tres preguntas: ¿tenemos acceso directo al equipo que construye? ¿El cliente puede darnos feedback real de usuario en las primeras dos semanas? ¿Hay algo concreto que shipped a los 45 días?

Si las tres son sí, arrancamos. Si alguna es no, explicamos por qué y cómo resolver eso antes de firmar. Perdimos algunos proyectos con ese filtro. Los que entraron fueron mejores.
...
**Spark Club** — Plataforma de membresías para un social club tech en CABA. Fuimos desde research con 12 socios hasta producción en 11 semanas. El flujo crítico (onboarding de nuevo socio + primer evento) pasó de 7 pasos a 3. Tasa de completación del onboarding: 34% → 81%.

**EEVA Studios** — Rediseño del sistema de booking para un estudio de fotografía y video. El cliente llegó con un formulario de Google que tardaba 20 minutos en completar y requería seguimiento manual por email. Salimos con un sistema propio que integra disponibilidad en tiempo real: el 78% de los bookings se cierran sin intervención manual.

## Impacto

En 18 meses: 8 productos entregados, 2 clientes convertidos a proyectos recurrentes, 3 referidos directos entre el portfolio. Operamos sin inversión externa.
